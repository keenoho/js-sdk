  ...
  return [
    ...
    buildConfig({
      ...
      output: [
        ...
        {
          entryFileNames: '[name].esm.external.js',
          format: 'esm',
          exports: 'named',
        },
        {
          entryFileNames: '[name].cjs.external.js',
          format: 'cjs',
          exports: 'default',
        },
      ],
    }),
    // browser external minify: umd + ems + cjs
    buildConfig({
      isBrowser: true,
      isEs5: true,
      useExternal: true,
      ...
      output: [
        ...
        {
          entryFileNames: '[name].esm.external.min.js',
          format: 'esm',
          exports: 'named',
        },
        {
          entryFileNames: '[name].cjs.external.min.js',
          format: 'cjs',
          exports: 'default',
        },
      ],
